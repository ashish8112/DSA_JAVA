...
// minimum distance which has maximum distance between two station so taking 6 will be like that -> 3 6 12 <6> A(18) <1> 19 <6> B(25) <6> C(31) <2> 33  so tthree station A, B and C is used 
// we can notice that 6 is minimum maximum distance in between the gas station.
